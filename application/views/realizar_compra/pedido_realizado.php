<div id="">
    ...
    <button><?= anchor("compra/enviar_detalle", "Deseo que me envíen los detalles") ?></button>
    <button><?= anchor("compra/enviar_pdf/$pedido", "Deseo que me envíen los detalles en PDF") ?></button>
</div>
